...
```
โจทย์ต้องการให้สร้างระบบที่บอกว่าลอตเตอรี่ที่ได้มาจะได้รางวัลกี่บาทเมื่อเทียบกับรางวัลที่ 1

Input:
บรรทัด 1: ผลรางวัลลอตเตอรี่
บรรทัด 2: ลอตเตอรี่ที่ซื้อ

Output: จำนวนเงินที่ได้ หากไม่ได้คำตอบ = 0

Constraints: เลขและตัวอักษร ยิ่งจำนวนตัวที่ตรงน้อย รางวัลที่ได้ก็จะต่างออกไป
```
...
```text
Step 1: สร้าง input
Step 2: if, else ว่าถ้าหากตัวอักษรแรกตรงกัน จะเทียบต่อว่าถูกเลขท้ายกี่ตัว และได้รางวัลเท่าไหร่ โดยเทียบแบบนี้เช่นกันกับเคสที่ตัวอักษรแรกไม่ตรงกัน หากตรงกับเงื่อนไขใด ให้แสดงผลจำนวนรางวัลตามนั้น
```
...
```
วิธีสุดท้ายของฉันเหมือนกับวิธีเดิม เพราะ code นี้ไม่ติด Testcase ใดๆ ตั้งแต่ครั้งแรก และ code ยังเขียนและเข้าใจได้ง่าย
```
...
```
เช็คว่าจะยังคงได้รางวัลหากตัวอักษรแรกตรง แต่เลขไม่ตรงเลย
```
...
```
เช็คว่าฉันกำหนดการเช็คตำแหน่งตัวเลขถูกต้องในเงื่อนไข
```
...
```
เช็คกับ Test Case 2 ว่ารางวัลจะต่างกันหากเลขที่ซื้อเหมือนกัน แต่ตัวอักษรต่างกัน
```
