...
Step 3: สร้าง for loop โดยให้ +1 เวลาที่ร้านเปิดตามระยะเวลา
Step 4: คัดมาแค่ตัวใน [] ที่อยู๋ในช่วงเวลาที่เช็ค
Step 5: แสดงผลคำตอบ
```
...
```
วิธีสุดท้ายของฉันคล้ายกับแผนแรก ต่างตรงที่ใน [] ฉันจะบวก 1 ในช่วงเวลาที่ร้านเปิด และ -1 ในเวลาที่ร้านปิด แล้วเขียน for loop ให้ +1 ลำดับนาทีถัดๆ ไปจนถึงก่อนนาทีที่ร้านปิด
```
...
```
Testcase นี้ฉันใช้สำหรับเทสโค้ดเบื้องต้น
```
...
```
เช็คว่า code คำนวณถูกต้องหากเวลาเปิดของร้านซ้อนทับกัน
```
...
```
เช็คว่าฉันเข้าใจระบบเปิดปิดร้านถูกต้อง โดยร้านจะไม่เปิดในระยะเวลาที่เป็น input นาทีที่ร้านปิด
```
