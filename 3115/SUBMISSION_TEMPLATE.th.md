...
```
โจทย์ต้องการให้สร้างระบบที่ดูว่าในแต่ละช่วงเวลาที่เราต้องการตรวจสอบ มีกี่ร้านที่เปิดอยู่

Input:
บรรทัดที่ 1: จำนวนร้านและจำนวนช่วงเวลาที่ต้องการตรวจ
บรรทัดถัดไปตามจำนวนร้าน: เวลาเปิดและปิดร้าน
บรรทัดสุดท้าย: เวลาที่ต้องการตรวจทั้งหมด

Output: จำนวนร้านที่เปิดในแต่ละช่วงเวลา

Constraints: โจทย์ต้องการให้แสดงผลคำตอบในช่วงเวลาที่ลงตรวจเท่านั้น
```
...
Step 2: ตั้ง [0] ตามจำนวนนาทีใน 1 วันเพื่อเก็บค่าร้านที่เปิดในแต่ละนาที
Step 3: สร้าง for loop โดยให้ +1 เวลาที่ร้านเปิด และ +1 ตามระยะเวลาในร้านเปิด
Step 4: 
