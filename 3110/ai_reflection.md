...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3110 - สงคราม...ส่งด่วน |
| OJ submission ID, if submitted | 627105 |
| OJ status | Pass |
...
```text
ฉันถาม AI เกี่ยวกับการใช้เงื่อนไข if else ร่วมกับ dictionary
```
...
```text
AI ช่วยให้ฉันได้สังเกตการเขียนเงื่อนไขที่ผิด
```
...
```text
AI ช่วยให้ฉันได้เรียนรู้วิธีใหม่ในการเขียน code และลำดับการตรวจสอบ dictionary ของ code
```
