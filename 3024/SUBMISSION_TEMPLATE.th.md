...
```
โจทย์ต้องการให้สร้างระบบที่วิเคราะห์ว่าคะแนนโหวตที่ได้มาทั้งสามคะแนนนี้ มีหน้าม้าอวยอยู่ไหม

Input:
บรรทัด 1: คะแนนรวมของทั้งสามคน
บรรทัด 2: คะแนนสูงสุดจากทั้งสามคนนี้

Output:
แสดงผลว่ามีคนอวยไหม (Surprising/Not surprising)

Constraints: เราไม่สามารถรู้ได้ว่าคะแนนโหวตที่อยู่ตรงกลางระหว่างคะแนนสูงสุดและต่ำสุดคือเท่าไหร่ 
```
...
```text
Step 1: สร้าง Input คะแนนสูงสุดและคะแนนรวม
Step 2: ตั้งตัวแปรคะแนนที่เหลือหลังจากลบคะแนนสูงสุดออก
Step 3: สร้างฟังก์ชัน if else
...
```
วิธีสุดท้ายของฉันคล้ายกับแผนแรก แตกต่างกันตรงที่จะมีการตั้งตัวแปรคำนวณคะแนนต่ำสุดของทั้งสามคะแนนโหวต โดยสมมติให้คะแนนที่มากสุดเป็นลำดับ 2 เป็นจำนวนเท่ากับคะแนนสูงสุด
```
...
```
เช็คว่า code ให้คำตอบที่ถูกหากคะแนนโหวตทั้งหมดเป็น 0
```
...
```
เช็คว่า code ทำงานได้ถูกต้อง หากคะแนนโหวตอื่นนอกจากคะแนนสูงสุดเป็น 0
```
...
```
เช็คการทำงานที่ทั่วไปที่สุดของ code
```
...
```
ช่วยอธิบายในเรื่องที่ฉันอ่านยังไงก็ไม่เข้าใจ คือ การสมมติให้คะแนนที่มากสุดเป็นลำดับที่ 2 มีค่าเท่ากับคะแนนสูงสุด
```
