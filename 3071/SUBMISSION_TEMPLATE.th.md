...
```
โจทย์ต้องการให้สร้างระบบที่คำนวณว่ามีกี่จำนวนนับในช่วงจำนวน 2 จำนวนที่หารด้วยจำนวนนับที่กำหนดให้แล้วเหลือเศษตามที่ต้องการ

Input:
บรรทัดที่ 1: จํานวนนับ A
บรรทัดที่ 2: จํานวนนับ B (B > A)
บรรทัดที่ 3: ตัวหาร
บรรทัดที่ 4: เศษที่ต้องการ

Output: จำนวนเลขที่สอดคล้อง

Constraints: โจทย์ไม่ได้จำกัดจำนวนตัวเลขที่ต้องคำนวณในแต่ละครั้ง ทำให้ต้องเขียน code ที่สามารถรู้จำนวนตัวเลขจาก input ได้ด้วยตัวมันเอง
```
...
Step 2: ตั้งตัวแปรค่าของจำนวนคำตอบ = 0
Step 3: เขียนฟังก์ชัน for loop เพื่อไล่ดูเลขทีละตัว
Step 4: สร้างเงื่อนไขที่หากเลขตัวนั้นหารได้เศษที่ต้องการ จะเพิ่มค่าของคำตอบ 1 ค่า
Step 5: แสดงผลตัวแปรคำตอบ
```
...
```
ฉันใช้วิธีสุดท้ายเป็นวิธีเดียวกับแผนแรก เพราะโจทย์ไม่ได้มีเงื่อนไขหรือ testcases ที่ซับซ้อน ทำให้สามารถนำ code มาใช้ได้
```
...
```
เช็คว่าในการคำนวณตัวเลขในช่วง code ได้รวม input ทั้ง 2 ตัวด้วย
```
...
```
เช็คว่าในการคำนวณตัวเลขในช่วง code ได้รวมเลขตัวสุดท้ายที่เป็น input
```
...
```
เช็คว่าในการคำนวณตัวเลขในช่วง code ได้รวมเลขตัวแรกที่เป็น input
```
