...
```
โจทย์ต้องการให้สร้างระบบที่บวกลบคะแนนตาม input ที่ใส่โดยคะแนนเริ่มต้นคือ 0
Input: บรรทัดที่ 1: ใส่จำนวนการบวกลบแต้มเป็นจำนวนเต็มบวก (1 <= N <= 1000)
บรรทัดที่ 2: ใส่ + (+10 คะแนน) หรือ - (-5 คะแนน)

Output:
แสดงผลออกมาเป็นคะแนนสุดท้ายหลังบวกลบแล้ว

Constraints: input +,- มีได้มากถึง 1000 ตัว ทำให้ไม่สามารถเขียนให้ใส่ input เรียงกันหลายๆ บรรทัดได้
```
...
Step 2: ตั้งแต่ตัวแปรคะแนนเริ่มต้นโดยเท่ากับ 0
Step 3: สร้างฟังก์ชัน for loop โดยวนจำนวนครั้งตาม input ก่อนหน้า
Step 4: สร้าง input ให้ใส่เครื่องหมาย +,- และสร้างเงื่อนไขให้ +10 คะแนนหรือ -5 คะแนน
Step 5: แสดงผลคะแนนสุดท้ายหลังจบ loop
```
...
```
วิธีสุดท้ายของฉันเหมือนกับแผนแรก เพราะแผนนี้ code มีความซับซ้อนน้อยและไม่ยืดยาว เข้าใจได้ง่ายและทำงานได้ถูกต้องอยู่แล้ว
```
...
```
เช็คว่า code สามารถแสดงคะแนนสุดท้ายเป็นจำนวนเต็มลบ
```
...
```
เช็คว่า code แสดงคำตอบเป็น 0 หากไม่มีการเพิ่มหรือลดคะแนน
```
...
```
เช็คการทำงานของ code ถ้าต้อง loop หลายๆ รอบ
```
