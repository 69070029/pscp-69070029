...
```
โจทย์ต้องการให้แสดงผลข้อความ 5 บรรทัดที่ใส่ลงไปโดยมีกรอบสี่เหลี่ยมล้อมรอบโดยมี sapce ระหว่างข้อความและกรอบตามโจทย์กำหนด

Input: ข้อความจำนวน 5 บรรทัด

Output: ข้อความจำนวน 7 บรรทัดเมื่อนับรวมบรรทัดที่เป็นกรอบ

Constraints: เส้นกรอบทุกบรรทัดจะต้องอยู่ตำแหน่งเดียวกันทั้งหมด
```
...
Step 2: สร้าง for loop เพื่อใส่ input ลงใน list
Step 3: ค้นหาข้อความที่ยาวสุดใน list เพื่อกำหนดระยะของกรอบบน-ล่าง
Step 4: แสดงผลกรอบบน
Step 5: สร้าง for loop ไล่เช็คแต่ละข้อความใน list เพื่อสร้างกรอบล้อมซ้าย-ขวา
Step 6: แสดงผลกรอบล่าง
```
...
```
เช็คว่าจะยังมีช่องว่างในกรอบหากไม่มี input ข้อความ
```
...
```
เช็คว่าระยะกรอบทุกบรรทัดขึ้นอยู่กับข้อความที่ยาวที่สุด
```
...
```
เช็คว่า code รับ input เป็นตัวเลขได้
```
