...
```
โจทย์ต้องการให้สร้างระบบที่คำนวณสีผลลัพธ์จากการนำสี RGB 2 สีมาผสมกันด้วยการหาค่าเฉลี่ย

Input:
บรรทัด 1: ค่า R, G, B ของสีที่ 1
บรรทัด 2: ค่า R, G, B ของสีที่ 2

Output: ค่า R, G, B ของสีผลลัพธ์

Constraints: การหาค่าเฉลี่ยอาจทำให้เกิดเลขที่ไม่ลงตัว
```
...
```text
Step 1: import math
Step 2: รับ input 2 บรรทัด
Step 3: แสดงผลคำตอบโดยเขียนสูตรค่าเฉลี่ยพร้อมกับใช้ math.floor
```
...
```
เช็คการปัดเลขของ code หากค่าเฉลี่ยติดทศนิยม
```
...
```
เช็คว่า code จะไม่ปัดเลขขึ้นหรือลงหากคำตอบลงตัวอยู่แล้ว
```
...
```
เช็คการทำงานทั่วไปของ code เมื่อ input ทั้งหมดมีจำนวน > 0
```
