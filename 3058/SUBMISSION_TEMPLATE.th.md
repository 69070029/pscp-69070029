...
```
โจทย์ต้องการให้สร้างระบบที่คำนวณว่าจะต้องใช้อิฐก้อนเล็กได้น้อยสุดกี่ก้อนจากอิฐทั้งหมดที่มีเพื่อสร้างสะพานตามความยาวที่กำหนด

Input:
จำนวนเต็มบวก 3 บรรทัด
บรรทัด 1: จำนวนอิฐก้อนเล็ก
บรรทัด 2: จำนวนอิฐก้อนใหญ่
บรรทัด 3: ความยาวของสะพาน

Output:
จำนวนอิฐก้อยเล็กที่ต้องใช้ ถ้าไม่สามารถสร้างสะพานได้ ให้ตอบ -1

Constraints: โจทย์มี Testcases ที่ไม่สามารถสร้างสะพานได้ ทำให้ต้องเขียนเงื่อนไขเพิ่มเติมนอกจากการเขียนสมการคำนวณ
```
...
```text
Step 1: สร้าง Input ใส่ข้อมูล
Step 2: คำนวณจำนวนอิฐก้อนใหญ่ที่ใช้
Step 3: คำนวณความยาวสะพานที่เหลือ
Step 4: คำนวณจำนวนอิฐก้อนเล็กที่ใช้
Step 5: สร้างเงื่อนไข หากจำนวนอิฐที่มีน้อยกว่าจำนวนที่ต้องใช้ ให้ตอบ -1
Step 6: แสดงผลคำตอบ
```
...
```
วิธีสุดท้ายของฉันคล้ายกับแผนแรกเกือบทั้งหมด มีการเพิ่ม code บางส่วน คือ
- มีการเขียน if else ในการหาความยาวสะพานหลังใช้อิฐก้อนใหญ่แล้ว
```
...
```
เช็คว่า code สามารถทำงานได้หากสะพานสามารถสร้างเสร็จโดยไม่ต้องใช้อิฐก้อนเล็ก
```
...
```
เช็คว่า code ทำงานได้หากไม่มีอิฐก้อนใหญ่อยู่เลย 
```
...
```
เช็คว่า code ให้คำตอบที่สมเหตุสมผล หาก input ทั้งหมดเป็น 0
```
