...
```
โจทย์ต้องการให้สร้างระบบที่บอกชื่อเต็มของไพ่โดยแปลงตามสัญลักษณ์ที่ได้รับ

Input: แต้มและตัวย่อกลุ่มของไพ่

Output: ชื่อเต็มของไพ่

Constraints: แต้มของไพ่เป็นได้ทั้งเลขและตัวอักษร (A, J, Q, K)
```
...
```text
Step 1: สร้าง input
Step 2: if, else แต้มไพ่ โดยดูจากตัวอักษรที่ในข้อความโดยไม่รวมตัวสุดท้ายซึ่งเป็นตัวย่อกลุ่มไพ่ หากเป็นตัวเลข จะแสดงตามเลขนั้นๆ หากเป็นอักษร จะแสดงเป็นชื่อเต็มของแต้ม
Step 3: if, else กลุ่มไพ่ โดยดูจากตัวอักษรตัวสุดท้ายของข้อความ โดยผลลัพธ์เป็นชื่อเต็มของตัวอักษรนั้นๆ ตามโจทย์กำหนด
Step 4: แสดงชื่อไพ่ตามรูปแบบที่โจทย์กำหนด
```
...
```
เช็คว่า code อ่านไพ่ได้ถูกต้อง
```
...
```
เทียบกับ Testcase 1 ว่า code ให้คำตอบได้หากแต้มเป็นเลขสองหลัก
```
...
```
เช็คว่า code ให้คำตอบได้หาก input เป็นพิมพ์เล็ก
```
